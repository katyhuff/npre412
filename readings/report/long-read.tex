...
In NPRE 412, a fraction of your grade is earned with reading a compelling 
...
After considering and ranking the books on a recommended list, each student 
will be assigned a different book from from that list, based on your preferences.  

\section{Report (50\%)}
In a signficant (5-10 pages), sophisticated document, describe the content of the book and 
...
\section{Video Submission (25\%)}
Record a 5-minute video presentation that communicates the contents of the 
report, and submit it in video format to Canvas. Your face and voice must be present in the video. 
I recommend including slides in this presentation, though creative approaches 
are welcome.

Your grade for this presentation will be based on your presentation style as 
well as ability to communicate the content of this report quickly. It will be 
graded by me, as well as your peers. 

\section{Peer Reviews (25\%)}
A portion of your grade will be gained by reviewing the presentations submitted by all other students on Canvas.
You will be encouraged to consider the following rubric while conducting this 
review. 

\begin{itemize}
        \item[\textbf{[10 pts]}] Did the presentation engage serious questions regarding the author's background and viewpoint as well as the target audience and public reception?
        \item[\textbf{[10 pts]}] Did the presentation clearly and comprehensively review the technical content of the book, including verifiability? 
        \item[\textbf{[10 pts]}] Did the presentation clearly and comprehensively review the non-technical content of the book, including invocation of emotions? 
        \item[\textbf{[10 pts]}] Did the presentation reveal and describe introspection on the part of the presenter?
        \item[\textbf{[10 pts]}] Did the presentation provide enough information to guide collegues on the book?
        \item[\textbf{[20 pts]}] How clear and effective were the visual components of the video?
        \item[\textbf{[20 pts]}] How clear and effective were the verbal components of the video?
        \item[\textbf{[10 pts]}] How professional and effective was the presentation style overall?
\end{itemize}
